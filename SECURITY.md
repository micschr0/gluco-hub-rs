...
**For sensitive issues** (credential leakage, auth bypass, secret exposure in logs): email [michael.schroeder@mailbox.org](mailto:michael.schroeder@mailbox.org) with the subject line `[gluco-hub-rs] Security report`. Do **not** open a public issue.
